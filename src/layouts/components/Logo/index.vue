<template>
  ...
  >
    <svg-icon name="State_Grid" size="35px" />
    <span class="logo-title" :style="{ color: textColor, fontSize: '16px' }" v-if="!collapse">
      国家电网
    </span>
  </div>
</template>
...
<script setup>
  ...
  const textColor = computed(() => {
    ...
    return whiteColors.indexOf(color) !== -1 ? '#175f3f' : '#fff';
  });
